...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://trinetra.live";
const SITE_NAME = "TRINETRA";
const SITE_TITLE = "TRINETRA — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | TRINETRA Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "trinetra", "trinetra osint", "trinetra ai", "trinetra intelligence",
  ],
  authors: [{ name: "TRINETRA Project", url: SITE_URL }],
  creator: "TRINETRA Project",
  publisher: "TRINETRA Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "TRINETRA — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TRINETRA — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ TRINETRA — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "TRINETRA",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "TRINETRA — OSINT Toolkit & Intelligence Platform",
  alternateName: ["TRINETRA", "TrinetraAI", "Trinetra OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="TRINETRA Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>

/**
 * TRINETRA Intelligence Layer — trinetra-intel
 *
...
const WIKIDATA_UA = 'TRINETRA-Intel/1.0 (https://trinetra.live; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'TRINETRA Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] TRINETRA Intelligence Layer starting...');
  await loadSanctions();

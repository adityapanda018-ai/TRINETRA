...
/**
 * Thin proxy to the TRINETRA Intelligence Layer (trinetra-intel).
 *
 * In Docker: fetches from http://trinetra-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[TRINETRA] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(

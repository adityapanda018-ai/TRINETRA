...
### The All-Seeing Eye — Open Source Intelligence & Global Surveillance Platform

[![Live Website](https://img.shields.io/badge/Live_Website-trinetra.live-success?style=for-the-badge&logo=google-chrome&logoColor=white)](https://trinetra.live)
[![Support TRINETRA](https://img.shields.io/badge/Support_Project-Patreon-FF424D?style=for-the-badge&logo=patreon&logoColor=white)](https://www.patreon.com/posts/159077425)
...
[🌐 Live Website](https://trinetra.live) · [Report Bug](https://github.com/simplifaisoul/trinetra/issues) · [Request Feature](https://github.com/simplifaisoul/trinetra/issues) · [Join Discord](https://discord.gg/umBykEpb98)
...
TRINETRA is a production-grade OSINT platform that provides situational awareness across multiple intelligence domains. Built with Next.js 16 and MapLibre GL, every data point is rendered via WebGL for 60fps performance even with thousands of concurrent entities on-screen.
...
```bash
docker pull ghcr.io/simplifaisoul/trinetra:latest
...
TRINETRA works **partially without any API keys** — all core feeds use public,
...
**🛠️ SUPPORT THE TRINETRA PROJECT**
The TRINETRA Global Intelligence Grid is entirely open-source, but running the backend scanners and data firehoses isn't cheap.

If you want to help keep the servers alive, and support us to get access to better tools unlock the **Special TRINETRA Console**, you can officially support the project here: 

🔗 [Support TRINETRA on Patreon](https://www.patreon.com/posts/159077425)
